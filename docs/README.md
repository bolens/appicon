...
| [consumer-contract.md](consumer-contract.md) | Exit codes, `resolve --json` fields, consumer rules |
| [resolve-result.schema.json](resolve-result.schema.json) | Machine-readable JSON schema (keep in sync with consumer-contract) |
| [sources.md](sources.md) | `sources.json` stages, order, `--order`, offline/MCP notes |
...
3. Keep [consumer-contract.md](consumer-contract.md) and [resolve-result.schema.json](resolve-result.schema.json) aligned.
